  ...
  return (
    <header className="bg-c5 sticky top-0 z-10 flex w-full max-w-5xl items-center justify-between pr-2">
      ...
      <nav className="grow px-5">
        <NavLinks className="flex justify-evenly" icons="h-10" admin={admin} />
      </nav>
    </header>
  );

  // return (
  //   <header className="sticky top-0 z-10 flex w-full max-w-5xl flex-col items-center justify-between bg-c5 pl-1 pr-2 md:hidden">
